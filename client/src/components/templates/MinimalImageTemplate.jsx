                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            {data.personal_info?.email && (
                                <div className="flex gap-2 flex-wrap">
                                    <Mail size={14} style={{ color: accentColor }} className="mt-2" />
                                    <span className="w-40 break-words">{data.personal_info.email}</span>
                                </div>
                            )}
                            {data.personal_info?.location && (
                                <div className="flex items-center gap-2">
                                    <MapPin size={14} style={{ color: accentColor }} />
                                    <span className="w-40 break-words">{data.personal_info.location}</span>
                                </div>
                            )}
                        </div>
                    </section>
