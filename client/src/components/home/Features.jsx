...
function Features() {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-8'>
          ...
          <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
            <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold text-slate-700">AI Resume Generation</h3>
                <p className="text-sm text-slate-600 max-w-xs">Instantly generate professional resumes using AI tailored to your skills, role, and experience.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold text-slate-700">Live Editing & Auto-Save</h3>
                <p className="text-sm text-slate-600 max-w-xs">Seamless editing experience with instant updates and zero data loss.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">Choose from modern, recruiter-approved templates optimized for Applicant Tracking Systems.</p>
              </div>
            </div>
          </div>
        </div>
